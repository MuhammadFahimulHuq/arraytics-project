...
import { AiFillCaretDown, AiOutlineLogout, AiOutlineUser } from 'react-icons/ai';
  ...
  return (
    <div>
        ...
        <div className={styles.container}>
          <header>
            ...
            {Authname == '' ? (
              ...
              <div className={`${styles.dropDownContainer} `} onClick={handleLogout}>
              <AiOutlineLogout />
                <span>Logout</span>
              </div>
              </div>
      ...
      <footer className={styles.footer}>
        <div>
          <p>
            An <span>arraytics</span> interview project @made by Muhammad Fahimul Huq
          </p>
        </div>
      </footer>
    </div>
